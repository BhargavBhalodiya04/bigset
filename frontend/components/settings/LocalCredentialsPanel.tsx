...
type ServiceName = "tinyfish" | "openrouter" | "openai";
...
const SERVICE_COPY = {
  ...
  openai: {
    ...
    description:
      "Use OpenAI models (GPT-4o, o1, o3 and more) as an alternative AI provider.",
