...
export default defineSchema({
  ...
  localCredentials: defineTable({
    service: v.union(v.literal("tinyfish"), v.literal("openrouter"), v.literal("openai")),
    keychainAccount: v.optional(v.string()),
    connectionMethod: v.union(v.literal("api_key"), v.literal("oauth")),
    verifiedAt: v.number(),
    updatedAt: v.number(),
    // For OpenAI-compatible providers: custom base URL (not a secret, stored in Convex).
